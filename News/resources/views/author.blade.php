...
<body>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <form id="addauthor" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header ">
                                <h4 class="modal-title text-dark fw-bold" id="exampleModalLabel">Add Author</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="file" name="authorimage" class="form-control text-dark bg-light"
                                        required>
                                </div>
                            </div>
            ...
            $(document).ready(function() {
              ...
              $(document).ready(function() {
                ...
                function getProducts(page) {
                    $.ajax({
                        url: '/pagination/author?page=' + page,
                        success: function(response) {
                ...
                $(document).on('click', '#deleteauthor', function() {
                    ...
                    cancelButtonColor: '#fd5c63',
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: '/deleteauthor/' + productId,
                                type: 'DELETE',
                                data: {
                                    "_token": "{{ csrf_token() }}"
                                },
                                success: () => {
                                    Swal.fire('Deleted!', 'The Author has been deleted.',
                                        'success');
  ...
  $('#updateAuthor input').on('input', function() {
    formChanged = true;
  });

  $('#updateAuthor').submit(function(e) {
    e.preventDefault();
    ...
    if (!formChanged) {
      ...
      return;
                    ...
                    let image = $('#author_image').prop('files')[0];

                    let formData = new FormData();
                    formData.append('up_id', up_id);
                    formData.append('up_author', author);
