        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="{{ url('/dashboard')}}" class="navbar-brand d-flex d-lg-none me-4">
                    <h3 class="mt-3 text-dark">Abuzaid News</h3>
                </a>
            ...
            <div class="container-fluid pt-5 px-4">
                <div class="row invoice-card-row justify-content-center">
                    <div class="col-xl-3 col-xxl-3 col-sm-6 ">
                        <div style="background-color: #ffa755;s" class="card  invoice-card">
							...
							<path fill-rule="evenodd"  fill="rgb(255, 255, 255)"
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">{{ $newscategoriesCount }}</h2>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div style="background-color: #68e365;"  class="card  invoice-card">
                            <div class="card-body d-flex">
                                <div class="icon me-3">
							...
							<path fill-rule="evenodd"  fill="rgb(255, 255, 255)"
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">{{$authorsCount}}</h2>
                                    <span class="text-white fs-18">Total Authors</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div style="background-color: #b48dd3;" class="card invoice-card">
                            <div class="card-body d-flex">
                                <div class="icon me-3">
                                    <svg width="35px" height="34px">
							<path fill-rule="evenodd"  fill="rgb(255, 255, 255)"
							...
							<path fill-rule="evenodd"  fill="rgb(255, 255, 255)"
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">{{$postnewsCount}}</h2>
                                    <span class="text-white fs-18">Total Post</span>
                                </div>
                            </div>
                        </div>
                    </div>
