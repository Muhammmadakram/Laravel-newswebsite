...
{{--
                        ...
                        <nav class="classy-navbar justify-content-between" id="newspaperNav">
                            ...
                            <div class="classy-menu" style="background:#efefef">
                                ...
                                <div class="classynav" style="display:none;">
                                    <div class="col-md-12">
                                        <a href="https://streakshot.com">
                                            <img src="{{ asset('img/logos.png') }}" class="img-responsive mb-2"
                                ...
                                <div class="container text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-3">
                                            <a href="{{ url('/Authur')}}">Authors</a>
                                        </div>

                                    </div>
                                    <p class="mt-2" style="font-size:60%">
                                        Copyright &copy; 2020
                                        <a href="/" class="text-info">www.Aznews.com</a>
                                    </p>
                                </div>
                            </div>
                        </nav>
                ...
                <div class="d-none d-lg-block">
                    <div class="container">
                        ...
                        <nav class="classy-navbar justify-content-between" id="newspaperNav">
                            ...
                            <div class="logo">
                                <a href="/">
                                    <img src="https://streakshot.com/public/img/logo_light.png"
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-widget-area mt-80">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="/">www.streakshot.com</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="bottom-footer-area mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p>
                            &copy; 2020 <a href="/" class="text-white">Aznews.com</a>
                        </p>
                    </div>
    ...
    new google.translate.TranslateElement(
        { pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.NARROW },
